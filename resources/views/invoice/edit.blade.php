...
@section('content')
            ...
            <div class="row">
                <div class="col">
                    ...
                    <form  enctype="multipart/form-data" action="{{ route('invoice.update',$invoice->id) }}"  class="row " method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <input type="date" name="invoice_Date" value="{{ $invoice->invoice_Date }}" id="">
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" name="Due_date" value="{{ $invoice->Due_date }}" id="">
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-4">
                                <h3> التحصيل </h3>
                                <input type="Amount_collection" class="all-money"  value="{{ $invoice->Amount_collection }}">
                            </div>
                    ...
                    <div class="row">
                            <div class="col-4">
                                <h3>مبلغ العموله</h3>
                                <input type="number" name="Amount_Commission" value="{{ $invoice->Amount_Commission }}">
                            </div>
                            <div class="col-4">
                                <h3> الخصم </h3>
                                <input type="number" name="Discount" class="tax" value="{{ $invoice->Discount }}">
                            </div>
                            <div class="col-4">
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input class="tax-100-equal" type="text" name="rate_value" >
                            </div>
                            <div class="col-6">
                                <h3>  Total </h3>
                                <input class="own-money"  type="text" name="Total" value="{{ $invoice->Total }}" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                            ...
                            <h3>الملاحظات</h3>
                            <textarea name="note" id="" cols="100" rows="2">{{ $invoice->note }}</textarea>
                    </div>
                    <div class="col-12">
                        <div class="row">
                            <div class="col-4">
                                @foreach ($attach as $x )
                                <img style="width: 100px; height:100px;" src="{{   asset('attach/'.$invoice->invoice_number).'/'.$x->file_name}}" alt="">
                                @endforeach
                            </div>
                            <div class="col-2">
