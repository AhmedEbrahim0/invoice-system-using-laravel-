...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير مدفوعه </span>
						</div>
					</div>
									...
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td>{{ $invoice->Total }}</td>
                                                <td  style="color: blue; font-size:20px;">{{ $invoice->Status }}</td>
